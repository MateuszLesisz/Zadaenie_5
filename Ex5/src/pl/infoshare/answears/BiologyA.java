...
public class BiologyA {
    ...
    public static void answearsC1Q1() {
        ...
        map.put(1, "Prokarionty");
        map.put(2, "Protisty");
        map.put(3, "Eukarionty");
    ...
    public static void answearsC1Q2() {
        Map<Integer, String> map = new HashMap<>();
        map.put(1, "Choronby metaboliczne");
        map.put(2, "Choroby układu krążenia");
        map.put(3, "Choroby autoimmunologiczne");
        System.out.println("a. " + map.get(1));
        System.out.println("b. " + map.get(2));
        System.out.println("c. " + map.get(3));
    ...
    public static void answearsC1Q3() {
        Map<Integer, String> map = new HashMap<>();
        map.put(1, "Wydalniczego");
        map.put(2, "Rozdrodczego");
        map.put(3, "Dokrewnego");
        System.out.println("a. " + map.get(1));
        System.out.println("b. " + map.get(2));
        System.out.println("c. " + map.get(3));
    ...
    public static void answearsC1Q5() {
        Map<Integer, String> map = new HashMap<>();
        map.put(1, "Adenina-tymina");
        map.put(2, "Tymina-guanina");
        map.put(3, "Guanina-adenina");
        System.out.println("a. " + map.get(1));
        System.out.println("b. " + map.get(2));
        System.out.println("c. " + map.get(3));
